  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-[#606c38] text-primary-foreground hover:bg-[#606c38]/90 border-[#78a643] border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-green-600 hover:bg-slate-100",
        secondary: "bg-[#606c38] text-primary-foreground hover:bg-[#606c38]/90 border-[#465831] border-b-4 active:border-b-0",
        ...
        sidebarOutline: "bg-[#78a643]/15 text-[#606c38] border-[#606c38] 300 border-2 hover:bg-[#78a643]/20 transition-none"
      },
      size: {
